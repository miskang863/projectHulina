      ...
      <Content padder style={styles.container}>
        ...
        <Card transparent style={styles.card}>
          <CardItem header style={styles.header}>
            <Text
              style={{ color: '#ffffff', fontSize: 20, fontWeight: '' }}
            >
              {file.name}
            </Text>
          </CardItem>
          ...
          >
            <Text
              style={{ color: '#ffffff', fontWeight: 'bold', fontSize: 20, paddingBottom: 5 }}
            >
              Info
            </Text>
            <Text style={{ color: '#ffffff', paddingBottom: 10 }}>{file.description}</Text>
            <Text style={{ color: '#ffffff', fontSize: 12, paddingBottom: 10 }}>
              {file.address.street_address}
            </Text>
            <Text style={{ color: '#ffffff', fontSize: 12, paddingBottom: 5 }}>
